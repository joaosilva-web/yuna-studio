      ...
      <Container>
        <div className="grid items-start gap-16 lg:grid-cols-2">
          ...
          <div data-reveal>
            ...
            {/* Featured card */}
            <div data-reveal data-reveal-delay="2" className="group relative mt-12 overflow-hidden rounded-2xl bg-accent p-8 transition-all duration-500 hover:shadow-[0_8px_48px_rgba(255,77,141,0.2)]">
              ...
              <p className="relative mt-4 max-w-sm text-sm leading-relaxed text-background/70">
                ...
                diretamente com o cliente, garantindo que a visão do produto seja
                traduzida em excelência técnica.&rdquo;
              </p>

              <div className="relative mt-6 flex h-10 w-10 items-center justify-center rounded-full border border-background/20 transition-all duration-300 group-hover:bg-background/10">
                <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4 text-background" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="flex flex-col gap-4 lg:pt-16">
            {pillars.map((pillar, i) => (
              <div key={pillar.title} data-reveal data-reveal-delay={`${i + 1}`}>
                <Card className="group flex items-start gap-5">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-white/[0.06] bg-surface text-accent transition-all duration-500 group-hover:border-accent/20 group-hover:shadow-[0_0_16px_rgba(255,77,141,0.08)]">
                    {pillar.icon}
                  </div>
                  <div>
